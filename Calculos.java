...
public class Calculos {
    ...
    public String ContaMatematica(String Conta, ArrayList<Integer> Prioridade) {
		...
		if(Ultimo == false)ContaPrimaria+=NumerosEscritos[1];
		else if(Ultimo == true)ContaPrimaria+=NumerosEscritos[0];
    ...
    //Função responsável por realizar as ações necessárias para fazer a conta de soma ou subtração
